...
balance= doc.data['Current Balance'];
  ...
  updateData(String balance,String lb ) async {
    ...
    await databaseReference.collection("Balance")
        .document(uid)
        .setData({
        ...
        child: Column(
          children: <Widget>[SizedBox(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        Text("$balance", style: TextStyle(fontSize: 50,color: Colors.white)),
                        SizedBox(height: 20,),
                        Text("Balance", style: TextStyle(fontSize: 50,)),
                      ],
                    ),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    IconButton(
                      ...
                      iconSize: 50,
                      onPressed: () =>{
                        add_money(_moneyController.text)
                      },
                    ),
                    SizedBox(width: 192,),
                    IconButton(
                      ...
                      iconSize: 50,
                      onPressed: ()=>{
                        remove_money(_moneyController.text)
                      }
                    )
                  ],
                ),
            ...
            RaisedButton(
                ...
                onPressed:()=> {Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> MainHome()))}),
            Container(height: 110,color:  Color.fromRGBO(27, 175, 4, 1),)
          ],
        ),
      ),
    );
